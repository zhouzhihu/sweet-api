      ...
      <div style="height: 380px; overflow: auto">
        <div v-for="(it, i) in fullScripts" :key="i" @click="open(it)" class="ma-tree-item">
          <div class="ma-tree-hover" style="padding-left: 5px;">
            <sweet-text-icon v-if="it._type === 'api'" v-model="it.method"/>
            <sweet-text-icon v-if="it._type === 'function'" value="function"/>
...
export default {
  name: 'SweetRecentOpened',
  components: {SweetTextIcon, MagicDialog},
  data() {
    return {
      visible: false,
      scripts: []
