<template>
  <div style="width: 100%">
    ...
    <sweet-input icon="upload" :readonly="true" style="width: 100%" placeholder="未选择文件" :onClick="choseFile" :value="filename"/>
  </div>
</template>

<script>
import SweetInput from './sweet-input'
export default {
  name: 'SweetFile',
  components: { SweetInput },
  props: {
    placeholder: {
      type: String,
      default: '',
