<template>
  <div class="ma-json-container">
    <div class="json-view f_c">
      ...
      <sweet-json-tree :jsonData="jsonData" :forceUpdate="forceUpdate" class="view-box" v-on:jsonClick="handleJsonClick"></sweet-json-tree>
    </div>
      ...
      <div class="panel-box f_c" v-if="fieldObj.dataType && fieldObj.dataType !== 'Object' && fieldObj.dataType !== 'Array'">
        ...
        <div class="box-item">
          ...
          <div class="item-content">
            <sweet-select :options="bodyTypes" :value.sync="fieldObj.dataType" default-value="String" style="width: 100%"/>
          </div>
        </div>
        <template v-if="type == 'request'">
          <div class="box-item">
            ...
            <div class="item-content">
              <div style="width: 25px; height: 25px;"><sweet-checkbox :value.sync="fieldObj.required"/></div>
            </div>
          </div>
          <div class="box-item">
            <div class="item-title">默认值</div>
            <div class="item-content">
              <sweet-input :value.sync="fieldObj.defaultValue" style="width: 100%"/>
            </div>
          </div>
          <div class="box-item">
            <div class="item-title">验证方式</div>
            <div class="item-content">
              <sweet-select :options="validates" :value.sync="fieldObj.validateType" default-value="pass" style="width: 100%"/>
            </div>
          </div>
          <div class="box-item">
            <div class="item-title">表达式或正则表达式</div>
            <div class="item-content">
              <sweet-input :value.sync="fieldObj.expression" style="width: 100%"/>
            </div>
          </div>
          <div class="box-item">
            <div class="item-title">验证说明</div>
            <div class="item-content">
              <sweet-input :value.sync="fieldObj.error" style="width: 100%"/>
            </div>
          </div>
        </template>
        ...
        <div class="box-item">
          ...
          <div class="item-content">
            <sweet-input :value.sync="fieldObj.description" style="width: 100%"/>
          </div>
        </div>
...
<script>
  ...
  import SweetJsonTree from './sweet-json-tree'
